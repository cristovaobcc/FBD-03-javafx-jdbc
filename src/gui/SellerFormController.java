...
/**
 * Classe de controle de eventos da Gui SellerForm.fxml. Serve tanto para
 * carregar dados de departamentos, como para inserir dados deles.
 *
 */
public class SellerFormController implements Initializable {
	...
	/**
	 * Registra um {@link DataChangeListener} que pode "ouvir" as mudanças de uma
	...
	/**
	 * Executa o método DataChangeListener.onDataChanged() em cada listener inscrito
	 * na instância desta classe.
	 */
	...
	/**
	 * Obtém os dados da view SellerForm e devolve-os configurados num Seller.
	 * 
	 * @return {@link Seller}
	 */
	private Seller getFormData() {
		...
		if (dpBirthDate.getValue() == null) {
			...
			// pega o valor que está num DatePicker
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		// chave correspondente à instrução validationException.addError("name", "Field
		// can't be empty");
		labelErrorName.setText(fields.contains("name") ? errors.get("name") : "");
		
		// chave correspondente à instrução validationException.addError("email", "Field
		// can't be empty");
		labelErrorEmail.setText(fields.contains("email") ? errors.get("email") : "");
						
		// chave correspondente à instrução validationException.addError("baseSalary",
