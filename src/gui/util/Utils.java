...
public class Utils {
	...
	/**
	 * Devolve o stage a partir de objeto de evento passado como argumento.
	 * 
	...
	/**
	 * Converte um valor string para inteiro. Caso falhe, devolve null.
	 * 
	 * @param str String
	 * @return Integer
	 */
	...
	/**
	 * Método que preenche a célula de uma tableColumn com um número decimal de até
	 * decimalPlaces casas.
	 * 
	 * @param <T>
	...
	/**
	 * Formata a data de DatePicker conforme o format.
	 * 
